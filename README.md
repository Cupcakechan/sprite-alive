...
**[▶ Try it live](https://YOUR-USERNAME.github.io/sprite-alive/)**
...
1. Open the [live page](https://YOUR-USERNAME.github.io/sprite-alive/) (or download `index.html` and double-click it — it works offline).
...
Alpha 0.1 — feedback welcome via [issues](../../issues).
